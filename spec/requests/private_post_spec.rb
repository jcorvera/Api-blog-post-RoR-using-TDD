...
RSpec.describe 'Posts with authentication', type: :request do
    ...
    let!(:create_params) { {'post'=>{ 'title'=>'Hola este es un texto de entrada','content'=>'contenido', 'published'=>true }}}
    let!(:update_params) { {'post'=>{ 'title'=>'updating este es un texto de entrada','content'=>'this is a new content', 'published'=>false }}}

    describe 'GET /posts/{id}' do
        context 'with valid auth' do
            context 'when requisting other"s author"s post' do
